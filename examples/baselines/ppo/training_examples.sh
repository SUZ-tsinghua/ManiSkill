...
do
    CUDA_VISIBLE_DEVICES=0 python ppo.py --env_id="PokeCube-v1" --num_envs=4096 --update_epochs=8 --num_minibatches=32 --total_timesteps=10_000_000 --eval_freq=10 --num-steps=20 --wandb_entity="boyuanchen21-tsinghua-university" --track --seed=$seed
